...
if __name__ == "__main__":
    ...
    movies = pickle.load(open(os.path.join('D:\\mini project', 'C:\\Users\\jenym\\OneDrive\\Documents\\movie recommendation\\movie_list.pkl'), 'rb'))

    # Load similarity DataFrame
    similarity = pickle.load(open(os.path.join('D:\\mini project', 'C:\\Users\\jenym\\OneDrive\\Documents\\movie recommendation\\similarity.pkl'), 'rb'))
